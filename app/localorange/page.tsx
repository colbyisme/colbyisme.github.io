...
export const metadata = {
  title: `${siteConfig.author} / Local Orange`,
  description: "Most of my musical ventures are through the lens of Local Orange...",
};

export default function LocalOrangePage() {
  const project = projects[0]; // Local Orange
    ...
    <>
      <main className="content">
        ...
        <section className="project-navigation">
          <div className="container">
            <Link href="/sessionsong" className="next" title="Next Session Work and Songwriting">
