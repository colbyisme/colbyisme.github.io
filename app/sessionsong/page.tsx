...
export const metadata = {
  title: `${siteConfig.author} / Session Work and Songwriting`,
  description: "Besides Local Orange, I've provided bass, drum, percussion...",
};

export default function SessionSongPage() {
  const project = projects[1]; // Session Work
    ...
    <>
      <main className="content">
        ...
        <section className="project-navigation">
          <div className="container">
            <Link href="/localorange" className="prev" title="Previous Local Orange">
              <span className="h2">Previous</span>
              <h2>Local Orange</h2>
            </Link>
            <Link href="/engineerprod" className="next" title="Next Engineering, Production, Live Sound">
