...
export const metadata = {
  title: `${siteConfig.author} / Engineering, Production, Live Sound`,
  description: "I've helped record other bands along with my own music...",
};

export default function EngineerProdPage() {
  const project = projects[2]; // Engineering
    ...
    <>
      <main className="content">
        ...
        <section className="project-navigation">
          <div className="container">
            <Link href="/sessionsong" className="prev" title="Previous Session Work and Songwriting">
              <span className="h2">Previous</span>
              <h2>Session Work and Songwriting</h2>
            </Link>
            <Link href="/vgcomp" className="next" title="Next Video Game Composition and Arrangement">
              <span className="h2">Next</span>
              <h2>Video Game Composition and Arrangement</h2>
            </Link>
          </div>
        </section>
      </main>
